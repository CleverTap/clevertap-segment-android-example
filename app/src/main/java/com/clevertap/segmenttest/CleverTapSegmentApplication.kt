...
class CleverTapSegmentApplication : Application() {
    ...
    private  val WRITE_KEY = "UghsI6ubzcaAsplNVSOtx6qf7AXX1Hfc"
        ...
        analytics.onIntegrationReady<CleverTapAPI>(CLEVERTAP_KEY) { instance: CleverTapAPI? ->
            ...
            if(instance!=null){
                ...
                clevertap!!.syncListener = object :SyncListener{
                    override fun profileDidInitialize(CleverTapID: String) { Log.d("CT_PROFILE_INITIALIZED", CleverTapID) }
                    override fun profileDataUpdated(updates: JSONObject) { Log.d("CT_PROFILE_UPDATES", updates.toString()) }
                }
